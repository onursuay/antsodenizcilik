...
export function ProcessingOverlay({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/40 px-4 backdrop-blur-[2px]">
      <div className="booking-loading-panel w-full max-w-4xl overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-[0_32px_120px_rgba(15,23,42,0.2)]">
        <div className="flex flex-col items-center px-6 py-10 text-center sm:px-10 sm:py-12">
          ...
          />
          <p className="mt-7 text-lg font-semibold text-slate-900">{title}</p>
          <p className="mt-2 max-w-xl text-sm leading-7 text-slate-500">{description}</p>

          <div className="mt-7 w-full max-w-lg rounded-full bg-slate-100 p-1">
