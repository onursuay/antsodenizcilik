...
- **Canlı site:** https://ticket.antsodenizcilik.com
...
# App
NEXT_PUBLIC_APP_URL=https://ticket.antsodenizcilik.com
...
AKGUNLER_CALLBACK_URL=https://ticket.antsodenizcilik.com/api/akgunler/payment-callback
```
